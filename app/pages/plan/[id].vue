          ...
          <div class="lg:basis-1/3" v-for="(child,idx) in item" :key="idx">
              <div class="w-full lg:px-3 lg:pb-3 mx-auto text-center">
                <div class="card-box bg-white px-3 hover:shadow-lg rounded-lg  transition delay-150 duration-300 ease-in-out">
                  ...
                  <NuxtLink to="/product" class="btn text-black cursor-pointer mx-auto mt-7 mb-16 md:w-[9.75rem] leading-8 border border-black border-solid text-center inline-block box-border hover:border-primary-blue hover:bg-primary-blue hover:text-white transition delay-150 duration-300 ease-in-out">{{ planLang[locale]['plan:more'] }}</NuxtLink>
                </div>
              </div>
            </div>
        </template>
  ...
  <section :class="{'hidden':!info?.successCaseList?.length}" class="w-full m-auto text-center bg-white text-black py-5 px-4 xl:px-0 lg:py-24">
    <div class="max-w-main m-auto">
      <div class="flex items-center justify-between mb-12">
        ...
        <NuxtLink to="/case" class="hidden lg:inline-block px-4 text-black cursor-pointer md:min-w-[9.75rem] leading-8 border-2 border-black border-solid text-center box-border hover:border-primary-blue hover:bg-primary-blue hover:text-white transition delay-150 duration-300 ease-in-out">{{ planLang[locale]['plan:more'] }}</NuxtLink>
      </div>
      <UCarousel
      ...
      <NuxtLink to="/case" class="lg:hidden mt-12 block px-4 text-black cursor-pointer leading-8 border-2 border-black border-solid text-center box-border hover:border-primary-blue hover:bg-primary-blue hover:text-white transition delay-150 duration-300 ease-in-out">{{ planLang[locale]['plan:more'] }}</NuxtLink>
    </div>
  </section>
</template>
